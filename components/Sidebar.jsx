...
const storedColor =
  typeof window !== "undefined" ? localStorage.getItem("color") : "red";
          ...
          <section className="py-20">
            <Link href={`/user`} className="">
              <div
                ...
                style={{
                  background:
                    lastPathSegment === "user" ? `${storedColor}33` : "",
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <path
                    ...
                    style={{
                      stroke:
                        lastPathSegment === "user" ? `${storedColor}` : "",
                    }}
                  />
                  <path
            ...
            <Link href={`/user/terminal`} className="">
              <div
                className="flex gap-3 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
                style={{
                  background: title === "terminal" ? `${storedColor}33` : "",
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Link href={`/user/transaction`} className="">
              <div
                className="flex gap-3 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
                style={{
                  background: title === "transaction" ? `${storedColor}33` : "",
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {admin?.role === "superadmin" && (
              <Link href={`/user/merchant`} className="">
                <div
                  ...
                  style={{
                    background: title === "merchant" ? `${storedColor}33` : "",
                  }}
                >
                  {/* <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            {admin?.role === "superadmin" && (
              <Link href={`/user/route`} className="">
                <div
                  className="flex gap-4 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
                  style={{
                    background: title === "route" ? `${storedColor}33` : "",
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            {admin?.role === "superadmin" && (
              <Link href={`/user/health_report`} className="">
                <div
                  ...
                  style={{
                    background:
                      title === "health_report" ? `${storedColor}33` : "",
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            {admin?.role === "superadmin" && (
              <Link href={`/user/transaction_report`} className="">
                <div
                  ...
                  style={{
                    background:
                      title === "transaction_report" ? `${storedColor}33` : "",
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
