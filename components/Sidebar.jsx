...
const storedColor = color !== "undefined" ? color : "green";

// console.log(`${storedColor}33`, "color")

// const sect = `${storedColor}33`;
const sect = color !== "undefined" ? `${storedColor}33` : "#00800033";
        ...
        <section className="py-10">
          <Link href={`/user`} className="">
            <div
              ...
              style={{
                background: lastPathSegment === "user" ? sect : "",
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  ...
                  style={{
                    stroke: lastPathSegment === "user" ? `${storedColor}` : "",
                  }}
                />
                <path
              ...
              <h5
                ...
                style={{
                  color: lastPathSegment === "user" ? `${storedColor}` : "",
                }}
              >
                Dashboard
              </h5>
          ...
          <Link href={`/user/terminal`} className="">
            <div
              className="flex gap-3 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
              style={{
                background: title === "terminal" ? sect : "",
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  ...
                  className="group-hover:stroke-primary"
                  style={{
                    stroke: title === "terminal" ? `${storedColor}` : "",
                  }}
                />
                <path
                  d="M3 10H21"
              ...
              <h5
                className="text-dark group-hover:text-primary text-sm"
                style={{
                  color: title === "terminal" ? `${storedColor}` : "",
                }}
              >
                Terminal
              </h5>
          ...
          <Link href={`/user/transaction`} className="">
            <div
              className="flex gap-3 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
              style={{
                background: title === "transaction" ? sect : "",
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  ...
                  className="group-hover:stroke-primary"
                  style={{
                    stroke: title === "transaction" ? `${storedColor}` : "",
                  }}
                />
                <path
                  d="M3 10H21"
              ...
              <h5
                className="text-dark group-hover:text-primary text-sm"
                style={{
                  color: title === "transaction" ? `${storedColor}` : "",
                }}
              >
                Transaction
              </h5>
          ...
          {admin?.role === "superadmin" && (
            <Link href={`/user/merchant`} className="">
              <div
                ...
                style={{
                  background: title === "merchant" ? sect : "",
                }}
              >
                {/* <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path
                  ...
                  className="group-hover:stroke-primary"
                  style={{
                    stroke: title === "merchant" ? `${storedColor}` : "",
                  }}
                />
              </svg> */}
                <svg
                ...
                >
                  <path
                    ...
                    style={{
                      fill: title === "merchant" ? `${storedColor}` : "",
                    }}
                  />
                </svg>
                ...
                <h5
                  className="text-dark group-hover:text-primary text-sm"
                  style={{
                    color: title === "merchant" ? `${storedColor}` : "",
                  }}
                >
                  Merchant
                </h5>
          ...
          {admin?.role === "superadmin" && (
            <Link href={`/user/health_report`} className="">
              <div
                className="flex gap-4 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
                style={{
                  background: title === "health_report" ? sect : "",
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <path
                    ...
                    className="group-hover:fill-primary"
                    style={{
                      fill: title === "health_report" ? `${storedColor}` : "",
                    }}
                  />
                </svg>
                ...
                <h5
                  className="text-dark group-hover:text-primary text-sm"
                  style={{
                    color: title === "health_report" ? `${storedColor}` : "",
                  }}
                >
                  Health Report
                </h5>
          ...
          {admin?.role === "superadmin" && (
            <Link href={`/user/transaction_report`} className="">
              <div
                className="flex gap-4 hover:bg-secondary group rounded-lg px-5 py-2 items-center cursor-pointer mb-[25px]"
                style={{
                  background: title === "transaction_report" ? sect : "",
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <path
                    ...
                    style={{
                      fill:
                        title === "transaction_report" ? `${storedColor}` : "",
                    }}
                  />
                </svg>
